        ...
        <div className=" mx-auto">
          ...
          <div className="prose prose-lg ">
            ...
            <section className="mb-6">
              ...
              <p>User
              &quotUser&quot or &quotYou&quot or &quotYour&quot refers to you, as a user of the Services. A user is someone who accesses or uses the Services for the purpose of sharing, displaying, hosting, publishing, transacting, or uploading information or views or pictures and includes other persons jointly participating in using the Services including without limitation a user having access to &quotinstitute community&quot created with or without consent of the institute.
Content
&quotContent&quot will include (but is not limited to) images, photos, audio, video, events, location data, nearby places, and all other forms of information or data. &quotYour content&quot or &quotUser Content&quot means content that you upload, share or transmit to, through or in connection with the Services, such as likes, , images, photos, messages, profile information, and any other materials that you publicly display or displayed in your account profile. &quotThird Party Content&quot means content that comes from parties other than GMG or its users and is available on the Services.</p>
            </section>
