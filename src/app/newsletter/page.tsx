      ...
      <div className="bg-orange-500 py-16 px-4 sm:px-6 lg:px-8 text-white mt-24">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-xl max-w-3xl">
            Stay updated with our latest news, events, and initiatives through
          ...
          {newsletters.map((newsletter) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <button className="mt-4 bg-orange-500 text-white py-2 px-4 rounded-md hover:bg-orange-600 transition-colors">
                  Read Newsletter
                </button>
              </div>
            </div>
